...
def main():
    ...
    server_socket_msg.bind(('localhost', port2))  # faccio il binding per i messaggi
    server_socket_msg.listen()
    print(f"TCP server listening on {'localhost'}:{port2}...")
    ...
    while True:
        ...
        if choice == 'create':
            ...
            # ti mostra le stanze disponibilihttps://prod.liveshare.vsengsaas.visualstudio.com/join?D4527E5A76F29B67A83B3DC05CD9D7D9FDC4
